...
scenes = ["scene0000", "scene0059", "scene0106", 
          "scene0169", "scene0181", "scene0207"]

seed = 1
scene_name = "scene0106"
...
config = dict(
    TriplaneConfigs = "./configs/ScanNet/{scene_name}.yaml".format(scene_name=scene_name),
